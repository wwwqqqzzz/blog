...
tags:
  ...
  - react
  - tool-calling
title: 5.1 Agent基础原理：ReAct架构与工具调用
date: 2026-02-15
authors:
  - wqz
...
2022年，普林斯顿大学的研究人员发表了著名的 **ReAct 论文 (Reasoning + Acting)**。他们发现，只要在给大模型的神奇 Prompt（系统提示词）里，教会它像人类一样**交替进行“思考”和“行动”**，模型就能在一连串的循环中完成复杂的推理任务！
...
但文字是暧昧的。万一模型哪天抽风，没按格式或者连着说了一大堆废话，后端的代码就会因为无法抽取指令而当场崩溃。
...
不要指望这帮大模型懂什么叫代码。
在它的眼里，所谓的工具，只是你递给它的一本详尽的**字典说明书 (JSON Schema)**。
