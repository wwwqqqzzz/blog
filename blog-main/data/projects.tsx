export const projects: Project[] = [
  {
    title: 'WQZ个人博客',
    description: '🦖 基于 Docusaurus 静态网站生成器实现的个人博客',
    preview: '/img/project/blog.png',
    website: 'https://20030727.xyz/blog/',
    source: 'https://github.com/你的GitHub用户名/blog',
  ...
  {
    title: '项目名称1',
    description: '项目描述，简要介绍项目的功能和特点',
    preview: '/img/project/your-project1.png', // 项目预览图路径
    website: 'https://项目链接.com',
    source: 'https://github.com/你的GitHub用户名/项目仓库',
    tags: ['opensource'], // 可选标签: 'favorite', 'opensource', 'product', 'design', 'large', 'personal'
    type: 'web', // 项目类型: 'web', 'app', 'commerce', 'personal', 'toy', 'other'
  },
  {
    title: '项目名称2',
    description: '项目描述，简要介绍项目的功能和特点',
    preview: '/img/project/your-project2.png',
    website: 'https://项目链接2.com',
    source: 'https://github.com/你的GitHub用户名/项目仓库2',
    tags: ['personal'],
    type: 'app',
  },
  // 您可以继续添加更多项目...
